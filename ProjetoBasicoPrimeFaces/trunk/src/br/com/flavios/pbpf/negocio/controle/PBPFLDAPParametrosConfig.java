...
public class PBPFLDAPParametrosConfig {
	
   
    public static final String INITIAL_CTX = "com.sun.jndi.ldap.LdapCtxFactory";

    public static final String SERVIDOR = "ldap://ds-03-01.flavios.br:389";
    
    public static final String AUTENTICACAO = "simple";

    public static final String SEARCHBASE = "dc=flavios, dc=br";
 
    public static final String BASE_DN = "ou=UsuariosOABGO, dc=flavios, dc=br";
